...
export function formatTurtleSoupPreviewMessages(preview, maxLength = 1800) {
  ...
  return [
    ...splitHeadingAndTitle(preview.backendName, preview.draft.title, maxLength),
...
function splitHeadingAndTitle(backendName, title, maxLength) {
  const heading = `${backendName}海龟汤投稿预览`
